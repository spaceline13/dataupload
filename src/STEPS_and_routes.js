import {
    ...
    METADATA_SUBTITLE,
    METADATA_TITLE,
    SELECT_OBJECTS_INFOBOX,
    SELECT_OBJECTS_STEP_NAME,
    SELECT_OBJECTS_STEP_TEXT,
    SELECT_OBJECTS_SUBTITLE,
    SELECT_OBJECTS_TITLE,
    SELECT_TYPE_INFOBOX,
    SELECT_TYPE_STEP_NAME,
    SELECT_TYPE_STEP_TEXT,
    SELECT_TYPE_SUBTITLE,
    SELECT_TYPE_TITLE,
    UPLOAD_FILE_INFOBOX,
    UPLOAD_FILE_STEP_NAME,
    UPLOAD_FILE_STEP_TEXT,
    UPLOAD_FILE_SUBTITLE,
    UPLOAD_FILE_TITLE,
    UPLOAD_STREAM_INFOBOX,
    UPLOAD_STREAM_STEP_NAME,
    UPLOAD_STREAM_STEP_TEXT,
    UPLOAD_STREAM_SUBTITLE,
    UPLOAD_STREAM_TITLE,
} from './EN_Texts';
...
export const STEPS2 = [
    ...
    {
        index: 1,
        name: UPLOAD_STREAM_STEP_NAME,
        text: UPLOAD_STREAM_STEP_TEXT,
        title: UPLOAD_STREAM_TITLE,
        subtitle: UPLOAD_STREAM_SUBTITLE,
        infobox: UPLOAD_STREAM_INFOBOX,
        route: ROUTE_UPLOAD_STREAM,
    },
    {
        index: 2,
        name: METADATA_STEP_NAME,
